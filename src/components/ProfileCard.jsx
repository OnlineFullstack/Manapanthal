...
export function ProfileCard({ name, age, occupation, location, imageUrl, membershipType = "Gold", membershipNumber = "12345" }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-105 border-2 hover:border-gray-400">
